              ...
              {expanded[i] && (
                <div className="recipe-body">
                  ...
                  <div style={{marginTop:"16px"}}>
                    {userTier === "pro_chef" ? (
                      <a href={"https://www.youtube.com/results?search_query=" + encodeURIComponent(recipe.name + " Nigerian recipe how to cook")} target="_blank" rel="noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"8px",background:"#FF0000",color:"white",padding:"8px 16px",borderRadius:"8px",fontSize:"0.82rem",fontWeight:600,textDecoration:"none",fontFamily:"Afacad Flux, sans-serif"}}>
                        ▶ Watch on YouTube
                      </a>
                    ) : (
                      <button onClick={onUpgrade} style={{display:"inline-flex",alignItems:"center",gap:"8px",background:"var(--bg)",color:"var(--muted)",padding:"8px 16px",borderRadius:"8px",fontSize:"0.82rem",fontWeight:600,border:"1.5px solid var(--border)",cursor:"pointer",fontFamily:"Afacad Flux, sans-serif"}}>
