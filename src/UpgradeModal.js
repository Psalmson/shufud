...
const upgradeStyle = `
  ...
  .upgrade-tier { border: 2px solid var(--border); border-radius: 16px; padding: 20px 16px; text-align: center; transition: all 0.2s; position: relative; cursor: default; }
        ...
        <div className="upgrade-modal">
          ...
          <div className="upgrade-body">
            ...
            <div className="upgrade-contact">
              <p>
                To upgrade, send a message to <strong>Shufud Support</strong> with your registered email and chosen plan.
              </p>
