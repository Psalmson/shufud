        ...
        <div className="recipe-modal-body">
          ...
          {recipe && !loading && (
            <>
              ...
              <div>
                {userTier === "pro_chef" ? (
                  <a href={"https://www.youtube.com/results?search_query=" + encodeURIComponent(mealName + " Nigerian recipe how to cook")} target="_blank" rel="noreferrer" className="recipe-modal-yt">
